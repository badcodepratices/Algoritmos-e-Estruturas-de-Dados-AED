...
class BinarySearchTree {
    ...
    /*
     * Usddaremos o método add para acomodar o caso de inserção do primeiro elemento
     * assim como dos seguintes. Como vimos nas restantes Estruturas de Dados, o 
     * primeiro elemento é sempre o nosso marcador. Isto é, se a referência para a raíz
     ...
     *             não for nula, então tentamos fazer a inserção considerando este nó como o parente.
     ...
     *             não for nula, então tentamos fazer a inserção considerando este nó como o parente.
     *      3. Se o valor por inserir não for menor nem maior que o do nó parente, logicamente,
     *         só pode ser igual. Neste caso, não inserimos porque:
     *          a. O valor por inserir já existe na Estrutura de Dados (evitamos valores duplicados)
     *          b. Por ser uma Árvore Binária, cada nó so pode ter dois descendentes no máximo. 
     *             O algoritmo usado determina casos de inserção à esquerda assim como à direita. 
